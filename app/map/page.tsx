  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <Link
        href="/"
        className="
        absolute top-10 lg:top-1 w-10 h-10 border border-blue-500/20 opacity-80 bg-white/5 backdrop-blur-sm
      ...
      <div className="lg:hidden absolute top-12 -z-10"> <SpinningSphere color="#FF0000" size={150} /> </div>
